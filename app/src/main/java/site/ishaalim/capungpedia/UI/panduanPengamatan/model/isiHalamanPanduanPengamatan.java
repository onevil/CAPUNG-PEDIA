package site.ishaalim.capungpedia.UI.panduanPengamatan.model;
...
public class isiHalamanPanduanPengamatan {
    ...
    public isiHalamanPanduanPengamatan(String header, String isi, String id, String imageURL, String imageCaption, String imagePhotographer, String quotes, String author) {
        this.header = header;
        this.isi = isi;
        this.id = id;
