package site.ishaalim.capungpedia.UI.petunjukPenggunaan.model;
...
public class isiHalamanPetunjukPenggunaan {
    ...
    public isiHalamanPetunjukPenggunaan(String header, String isi, String id, String imageURL, String imageCaption, String imagePhotographer, String quotes, String author) {
        this.header = header;
        this.isi = isi;
        this.id = id;
