package site.ishaalim.capungpedia.UI.MengenalCapung.model;
...
public class isiHalamanMengenalCapung {
    ...
    public isiHalamanMengenalCapung(String header, String isi, String id, String imageURL, String imageCaption, String imagePhotographer, String quotes, String author) {
        this.header = header;
        this.isi = isi;
        this.id = id;
